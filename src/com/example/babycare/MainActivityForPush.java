...
public class MainActivityForPush extends InstrumentedActivity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mainforpush);
		initView();   
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(MainActivityForPush.this, PushSetActivity.class);
